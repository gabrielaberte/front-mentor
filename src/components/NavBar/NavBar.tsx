...
const NavBar = () => {
  ...
  const [anchorElUserCompany, setAnchorElUserCompany] = React.useState(null);
  ...
  const handleOpenFeature = (event: any) => {
    setAnchorElUser(event.currentTarget);
  };

  const handleOpenCompany = (event: any) => {
    setAnchorElUserCompany(event.currentTarget);
  };
        ...
        <Toolbar disableGutters>
          ...
          >
            ...
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenFeature}>
                Feature{" "}
            ...
            <Menu
              ...
              open={Boolean(anchorElUserCompany)}
              onClose={handleCloseUserMenu}
            >
              <MenuItem onClick={handleCloseUserMenu}>
            ...
            <Tooltip
              title="Open settings"
              sx={{ marginLeft: "25px", fontFamily: "sans-serif !important" }}
            >
